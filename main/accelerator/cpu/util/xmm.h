...
{
	__m128i value_;
	/*template<typename>*/ friend class base_x<s32_x>;
	friend class s16_x;
	friend class s8_x;
	friend class u8_x;
public:
...
private:
	/*template<typename>*/ friend class base_x<s16_x>;
	friend class s32_x;
	friend class s8_x;
	friend class u8_x;
public:
...
class s8_x : public base_x<s8_x>
{
	__m128i value_;
private:
	/*template<typename>*/ friend class base_x<s8_x>;
	friend class s32_x;
	friend class s16_x;
	friend class u8_x;
public:
...
class u8_x : public base_x<u8_x>
{
	__m128i value_;
private:
	/*template<typename>*/ friend class base_x<u8_x>;
	friend class s32_x;
	friend class s16_x;
	friend class s8_x;
public:
...
#else	// WIN32
	return reinterpret_cast<const __v4si &>(value_)[index];
#endif	// WIN32
}
...
int32_t& s32_x::operator[](int index)
{
	...
	return value_.m128i_i32[index];
#else	// WIN32
	return reinterpret_cast<__v4si &>(value_)[index];
#endif	// WIN32
}
...
#else	// WIN32
	return reinterpret_cast<const __v8hi &>(value_)[index];
#endif	// WIN32
}
...
int16_t& s16_x::operator[](int index)
{
	...
	return value_.m128i_i16[index];
#else	// WIN32
	return reinterpret_cast<__v8hi &>(value_)[index];
#endif	// WIN32
}
...
#else	// WIN32
	return reinterpret_cast<const __v16qi &>(value_)[index];
#endif	// WIN32
}
...
char& s8_x::operator[](int index)
{
	...
	return value_.m128i_i8[index];
#else	// WIN32
	return reinterpret_cast<__v16qi &>(value_)[index];
#endif	// WIN32
}
