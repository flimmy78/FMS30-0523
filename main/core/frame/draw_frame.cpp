...
draw_frame::draw_frame() : impl_(new impl()), source_afd_code(-1) {}
draw_frame::draw_frame(const draw_frame& other) : impl_(new impl(*other.impl_))
{
	out_afd_command = other.out_afd_command;/*afd command*/
	source_afd_code = other.source_afd_code;/*src afd msg*/
}
...
{
	//out_afd_command = frame.out_afd_command;/*afd command*/
	//source_afd_code = frame.source_afd_code;/*src afd msg*/
}
...
{
	out_afd_command = frames[0].out_afd_command;/*afd command*/
	source_afd_code = frames[0].source_afd_code;/*src afd msg*/
}
draw_frame::~draw_frame(){}
draw_frame& draw_frame::operator=(draw_frame other)
{
	other.swap(*this);
	this->out_afd_command = other.out_afd_command;
	this->source_afd_code = other.source_afd_code;
	return *this;
}
