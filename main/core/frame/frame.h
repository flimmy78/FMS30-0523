...
public:
	//AFD_COMMAND out_afd_command;
	int source_afd_code = -1;
	core::field_mode  mode_ = core::field_mode(3);
};
...
public:	
	...
	virtual AFD_COMMAND* afd_command() const;// afd command
	virtual int src_afd_msg() const;
