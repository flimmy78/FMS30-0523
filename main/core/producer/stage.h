...
public:
	...
	std::future<void>				load_ext(int index, const spl::shared_ptr<frame_producer>& producer, bool preview = false, bool can_show_first_frame = true, const boost::optional<int32_t>& auto_play_delta = boost::optional<int32_t>()); //cue first frame
